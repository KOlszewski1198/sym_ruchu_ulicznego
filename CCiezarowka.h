...
class CCiezarowka : public CObiektDynamiczny
{
private:

public:
	/**
	*Konstruktor klasy CCiezarowka
	*
	*/
	CCiezarowka(CParametryDynGlob ObDyn, double x, double y, double XX, double YY, CMapa Mapa);
