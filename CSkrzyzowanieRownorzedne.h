...
class CSkrzyzowanieRownorzedne: public CObiektStatyczny
{
public:
	/**
	*Konstruktor klasy CSkrzyzowanieRownorzednie
	*
	*/
	CSkrzyzowanieRownorzedne(int x, int y, CParametryStatGlob param);
